...
spectr = fits.open("manga-8992-3704-MAPS-VOR10-MILESHC-MASTARSSP.fits")
...
def orbit_map(orb_groups,incl):
    ...
    #ax.yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
    #ax.xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
...
axs[0, 2].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[0, 2].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[0, 2].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[0, 2].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[0, 2].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[0, 2].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[0, 3].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[0, 3].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[0, 3].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[0, 3].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[0, 3].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[0, 3].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[0, 1].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[0, 1].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[0, 1].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[0, 1].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[0, 1].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[0, 1].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[2, 0].set_title(f"PGC 35706",fontdict = fontdict,pad = 100)
...
axs[1, 0].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[1, 0].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[1, 0].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[1, 0].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[1, 0].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[1, 0].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[1, 0].annotate(r"$\varphi = 0\degree$",(35,3),fontsize=3,style = "italic",path_effects=[pe.withStroke(linewidth=1, foreground="white")])
axs[1, 0].annotate(r"$M_{c}/M_{total} =$" +  f"{int(np.sum(image) * 100)}" + "%",(1,40), fontsize=4,path_effects=[pe.withStroke(linewidth=1, foreground="white")])
axs[1, 0].annotate(f"{bounds[1]} > $\lambda_z$ > {bounds[0]-0.05}",(24,40), fontsize=3,path_effects=[pe.withStroke(linewidth=1, foreground="white")])
...
axs[1, 1].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[1, 1].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[1, 1].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[1, 1].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[1, 1].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[1, 1].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[1, 1].annotate(r"$\varphi =$" + f"{incl}" + r"$\degree$",(33,3),fontsize=3,style = "italic",path_effects=[pe.withStroke(linewidth=1, foreground="white")])
...
axs[1, 2].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[1, 2].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[1, 2].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[1, 2].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[1, 2].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[1, 2].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[1, 3].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[1, 3].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[1, 3].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[1, 3].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[1, 3].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[1, 3].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[2, 0].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[2, 0].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[2, 0].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[2, 0].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[2, 0].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[2, 0].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[2, 0].annotate(r"$M_{c}/M_{total} =$" +  f"{int(np.sum(image) * 100)}" + "%",(1,40), fontsize=4,path_effects=[pe.withStroke(linewidth=1, foreground="white")])

axs[2, 0].annotate(f"{bounds[1]+0.05} > $\lambda_z$ > {bounds[0]}",(24,40), fontsize=3,path_effects=[pe.withStroke(linewidth=1, foreground="white")])
...
axs[2, 1].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[2, 1].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[2, 1].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[2, 1].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[2, 1].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[2, 1].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[2, 2].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[2, 2].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[2, 2].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[2, 2].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[2, 2].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[2, 2].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[2, 3].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[2, 3].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[2, 3].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[2, 3].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[2, 3].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[2, 3].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[3, 0].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[3, 0].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[3, 0].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[3, 0].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[3, 0].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[3, 0].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[3, 0].annotate(r"$M_{c}/M_{total} =$" +  f"{int(np.sum(image) * 100)}" + "%",(1,40), fontsize=4,path_effects=[pe.withStroke(linewidth=1, foreground="white")])

axs[3, 0].annotate(f"{bounds[1]+0.05} > $\lambda_z$ > {bounds[0]-0.05}",(24,40), fontsize=3,path_effects=[pe.withStroke(linewidth=1, foreground="white")])
...
axs[3, 1].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[3, 1].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[3, 1].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[3, 1].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[3, 1].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[3, 1].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[3, 2].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[3, 2].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[3, 2].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[3, 2].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[3, 2].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[3, 2].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
...
axs[3, 3].yaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))
axs[3, 3].xaxis.set_major_locator(tcr.IndexLocator(12,offset = -2.5))

axs[3, 3].yaxis.set_minor_formatter(tcr.NullFormatter())
axs[3, 3].xaxis.set_minor_formatter(tcr.NullFormatter())
axs[3, 3].yaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))
axs[3, 3].xaxis.set_minor_locator(tcr.IndexLocator(2,offset = -2.5))

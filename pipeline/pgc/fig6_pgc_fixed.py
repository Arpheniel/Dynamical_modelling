...
M_stars_total = 6.17e10  # [M_sun] — ПОЛНАЯ звёздная масса всей галактики
...
# Должны точно совпадать со значениями в run_forstand_grid_PGC_35706.py.
RHALO    = 107.0   # core radius лог. halo, в length-units Agama (= arcsec)
VHALO    = 154.0   # асимптотическая v_circ halo, км/с
HALOTYPE = "LOG"   # 'LOG' или 'NFW'
M_BH     = 1e6     # масса BH, M_sun
UPSILON  = 12.4    # M/L (уже учтён в M_stars_total ниже, здесь только для справки)

...
incl = incl_col1
model_index = 8  # Из neworbmap.py
gamma = -40  # = -gamma1 из run-скрипта (для transform наблюдательных карт)
...
agama_gamma = 40.0   # gamma1 из run-скрипта (PA на небе, +40° для LEDA).

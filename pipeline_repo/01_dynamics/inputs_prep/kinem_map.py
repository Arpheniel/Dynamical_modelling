...
def plot_comparison_maps():
    ...
    ax4.annotate(r"$V_{0}[км/с]$", (2, 28), fontsize=11, style="italic")
    ...
    ax7.annotate(r"$\sigma[км/с]$", (2, 28), fontsize=11, style="italic")
    ...
    fig.savefig("leda_2220522_model_vs_data.pdf", 
                format="pdf", 
                dpi=300, 
                bbox_inches='tight',
                pad_inches=0.05,

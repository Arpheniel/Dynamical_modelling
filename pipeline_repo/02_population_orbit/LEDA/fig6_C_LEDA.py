...
M_stars_total = 7.24e9  # [M_sun] финал C: L_total(1.51e9) × Υ(4.781)
...
# Параметры halo и BH для расчёта M_dyn в IFU (финал C, приор v=125).
RHALO    = 30.6    # r_s NFW, arcsec (космолог. приор)
VHALO    = 125.0   # V_max halo, км/с (ячейка приора)
HALOTYPE = "NFW"   # подход C — NFW
M_BH     = 1e7     # масса BH, M_sun
UPSILON  = 4.781   # M/L (уже учтён в M_stars_total)

...
incl      = float(args.get('INCL', 10))       # [REQ] inclination angle (0 is face-on, 90 is edge-on) [degrees]
...
filenameMGE = 'boschmge_NGC_524.txt'    # [REQ] file with parameters of the MGE model for the surface density profile (if MGE is used)
...
filenameVorBin1 = 'bins_NGC_524.txt' # [REQ] Voronoi binning scheme for this dataset
filenameHist1   = 'kinem_hist_lr.txt'    # [REQ] histogrammed representation of observed LOSVDs
filenameGH1     = 'kinem_gh_NGC_524.txt'# [REQ] Gauss-Hermite parametrization of observed LOSVDs (usually only one of these two
